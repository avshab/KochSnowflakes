...
int BaseSegment::GetIndex() const
{
...
bool BaseSegment::SetThirdCoordinate( BasePoint* p )
{
    if (!p->IsSetX())
    {
...
double BaseSegment::GetLenghtToPoint( const BasePoint& p )
{
...
BasePoint BaseSegment::GetProgPoint( const BasePoint& p )
{
...
BasePoint BaseSegment::GetPointLinesIntersect( const BaseSegment& l )
{
